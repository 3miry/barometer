...
`structured-rules-v1-dev` applies the provisional vocabulary to one report and
returns:
...
governed parent such as “correctness problem” is still a valid code when a report
...
The 37 synthetic cases are the development contract used to write the rules.

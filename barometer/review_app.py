...
function renderDetail(){{
 ...
 const e=i._edit,attrBad=i.attribution_status!=='single_family'&&i.attribution_status!=='single_variant',split=i.target_count>1;
